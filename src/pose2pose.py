...
## RUN (without obstacle) : rosrun turtlebot3drive pose2pose.py [x] [y] [theta] False
## theta is optional 
## RUN (with obstacle) : rosrun turtlebot3drive pose2pose.py [x] [y] True
    ...
    try:
        ...
        if len(argv) < 4:
            ...
            if len(argv) == 4:
                ...
                has_theta = True 
            turtlebot3.pose_to_pose(goal, has_theta, avoid_obstacle)
            print("ok")
